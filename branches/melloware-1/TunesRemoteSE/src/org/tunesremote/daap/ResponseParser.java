...
public class ResponseParser {
   ...
   public final static Pattern BRANCHES = Pattern.compile("(casp|cmst|mlog|agal|mccr|mlcl|mdcl|mshl|mlit|mupd|abro|abar|agar|apso|caci|avdb|cmgt|aply|adbs)");
   public final static Pattern STRINGS = Pattern.compile("(minm|cann|cana|cang|canl|asaa|asal|asar|ascn|asgn|assa|assn|assu|mcnm|mcna)");
