...
public class PlayerStatusChangedEvent extends EventObject {
	...
	private static final long serialVersionUID = 506306742820935350L;

	protected PlayerStatus oldStatus;

	protected PlayerStatus newStatus;

	public PlayerStatusChangedEvent(MediaPlayer player, PlayerStatus oldStatus, PlayerStatus newStatus) {
		super(player);
