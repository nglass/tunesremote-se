...
public class FilteredSongListChangedEvent extends EventObject {
	...
	private static final long serialVersionUID = 6728199064374133058L;

	public FilteredSongListChangedEvent(SongList newFilteredSongList) {
		super(newFilteredSongList);
	}
