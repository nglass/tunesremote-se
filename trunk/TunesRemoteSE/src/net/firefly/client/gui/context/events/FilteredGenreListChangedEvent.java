...
public class FilteredGenreListChangedEvent extends EventObject {
	...
	private static final long serialVersionUID = -8584233179508424757L;

	public FilteredGenreListChangedEvent(GenreList newFilteredGenreList) {
		super(newFilteredGenreList);
	}

	public GenreList getNewFilteredGenreList() {
		return (GenreList) source;
	}
}
