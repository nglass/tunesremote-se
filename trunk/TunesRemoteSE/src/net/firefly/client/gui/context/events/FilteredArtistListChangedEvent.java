...
public class FilteredArtistListChangedEvent extends EventObject {
	...
	private static final long serialVersionUID = 8559480770163586323L;

	public FilteredArtistListChangedEvent(ArtistList newFilteredArtistList) {
		super(newFilteredArtistList);
	}

	public ArtistList getNewFilteredArtistList() {
		return (ArtistList) source;
	}
}
