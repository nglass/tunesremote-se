...
public class PlaylistListChangedEvent extends EventObject {
	...
	private static final long serialVersionUID = 3121354983999802249L;

	public PlaylistListChangedEvent(PlaylistList newPlaylistList) {
		super(newPlaylistList);
	}

	public PlaylistList getNewPlaylistList() {
		return (PlaylistList) source;
	}
}